...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Questionnaire&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.description, description) || other.description == description)&&(identical(other.dateLabel, dateLabel) || other.dateLabel == dateLabel)&&(identical(other.backgroundImageUrl, backgroundImageUrl) || other.backgroundImageUrl == backgroundImageUrl)&&(identical(other.sortOrder, sortOrder) || other.sortOrder == sortOrder)&&(identical(other.isActive, isActive) || other.isActive == isActive)&&(identical(other.isComingSoon, isComingSoon) || other.isComingSoon == isComingSoon)&&(identical(other.activeFrom, activeFrom) || other.activeFrom == activeFrom)&&(identical(other.activeTo, activeTo) || other.activeTo == activeTo)&&(identical(other.showByCondition, showByCondition) || other.showByCondition == showByCondition)&&const DeepCollectionEquality().equals(other.questions, questions));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,dateLabel,backgroundImageUrl,sortOrder,isActive,isComingSoon,activeFrom,activeTo,showByCondition,const DeepCollectionEquality().hash(questions));

@override
String toString() {
  return 'Questionnaire(id: $id, title: $title, description: $description, dateLabel: $dateLabel, backgroundImageUrl: $backgroundImageUrl, sortOrder: $sortOrder, isActive: $isActive, isComingSoon: $isComingSoon, activeFrom: $activeFrom, activeTo: $activeTo, showByCondition: $showByCondition, questions: $questions)';
}
...
class _Questionnaire implements Questionnaire {
  const _Questionnaire({required this.id, required this.title, required this.description, this.dateLabel, this.backgroundImageUrl, this.sortOrder = 0, this.isActive = true, this.isComingSoon = false, @JsonKey(fromJson: _dateFromJson, toJson: _dateToJson) this.activeFrom, @JsonKey(fromJson: _dateFromJson, toJson: _dateToJson) this.activeTo, this.showByCondition, final  List<Question> questions = const <Question>[]}): _questions = questions;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,description,dateLabel,backgroundImageUrl,sortOrder,isActive,isComingSoon,activeFrom,activeTo,showByCondition,const DeepCollectionEquality().hash(_questions));
